...
SpawnOnlyWhen
{
	...
	Actions = 
	{
		SetGlobalFlagTrue {Name = "g_sP200Round3Monster1Gesetzt"},
...
Umspawn
{
	...
	Conditions = 
	{
		IsGlobalFlagTrue {Name = "g_sP200Round3Monster1Gesetzt"},
		IsGlobalFlagTrue {Name = "g_sP200Round2Solved"},
	...
	Actions = 
	{
		...
		SetGlobalFlagTrue {Name = "g_sP200ReadytoStartRound3Monster1"},
	}
}
...
Despawn
{
	...
	Actions = 
	{
		SetNpcFlagTrue {Name = "npc_sP200Figure9586Tot"},
	}
}
...
Respawn
{
	...
	Conditions = 
	{
		IsNpcFlagTrue {Name = "npc_sP200Figure9586Tot", UpdateInterval = 10},	
	...
	Actions = 
	{
		SetNpcFlagFalse {Name = "npc_sP200Figure9586Tot"},
		ChangeRace {Race = 111, NpcId = self},
