...
SpawnOnlyWhen
{
	...
	Actions = 
	{
		SetGlobalFlagTrue {Name = "g_sP200Round4Monster1Gesetzt"},
...
Umspawn
{
	...
	Conditions = 
	{
		IsGlobalFlagTrue {Name = "g_sP200Round4Monster1Gesetzt"},
		IsGlobalFlagTrue {Name = "g_sP200Round3Solved"},
	...
	Actions = 
	{
		...
		SetGlobalFlagTrue {Name = "g_sP200ReadytoStartRound4Monster1"},
	}
}
...
Despawn
{
	...
	Actions = 
	{
		SetNpcFlagTrue {Name = "npc_sP200Figure9593Tot"},
	}
}
...
Respawn
{
	...
	Conditions = 
	{
		IsNpcFlagTrue {Name = "npc_sP200Figure9593Tot", UpdateInterval = 10},	
	...
	Actions = 
	{
		SetNpcFlagFalse {Name = "npc_sP200Figure9593Tot"},
