...
SpawnOnlyWhen
{
	...
	Actions = 
	{
		SetGlobalFlagTrue {Name = "g_sP200Round2Monster7Gesetzt"},
...
Umspawn
{
	...
	Conditions = 
	{
		IsGlobalFlagTrue {Name = "g_sP200Round2Monster7Gesetzt"},
		IsGlobalFlagTrue {Name = "g_sP200Round1Solved"},
	...
	Actions = 
	{
		...
		SetGlobalFlagTrue {Name = "g_sP200ReadytoStartRound2Monster7"},
	}
}
...
Despawn
{
	...
	Actions = 
	{
		SetNpcFlagTrue {Name = "npc_sP200Figure9480Tot"},
	}
}
...
Respawn
{
	...
	Conditions = 
	{
		IsNpcFlagTrue {Name = "npc_sP200Figure9480Tot", UpdateInterval = 10},	
	...
	Actions = 
	{
		SetNpcFlagFalse {Name = "npc_sP200Figure9480Tot"},
		Goto {X = 117, Y = 137, NpcId = self, Range = 5, WalkMode = Walk, GotoMode = GotoForced},
	},
	DeathActions = 
	{
		SetNpcFlagTrue {Name = "npc_sP200Figure9480Tot"},
