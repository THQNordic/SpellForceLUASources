...
SpawnOnlyWhen
{
	...
	Actions = 
	{
		SetGlobalFlagTrue {Name = "g_sP200Round2Monster1Gesetzt"},
...
Umspawn
{
	...
	Conditions = 
	{
		IsGlobalFlagTrue {Name = "g_sP200Round2Monster1Gesetzt"},
		IsGlobalFlagTrue {Name = "g_sP200Round1Solved"},
	...
	Actions = 
	{
		...
		SetGlobalFlagTrue {Name = "g_sP200ReadytoStartRound2Monster1"},
	}
}
...
Despawn
{
	...
	Actions = 
	{
		SetNpcFlagTrue {Name = "npc_sP200Figure9477Tot"},
	}
}
...
Respawn
{
	...
	Conditions = 
	{
		IsNpcFlagTrue {Name = "npc_sP200Figure9477Tot", UpdateInterval = 10},	
	...
	Actions = 
	{
		SetNpcFlagFalse {Name = "npc_sP200Figure9477Tot"},
		Goto {X = 117, Y = 121, NpcId = self, Range = 5, WalkMode = Walk, GotoMode = GotoForced},
	},
	DeathActions = 
	{
		SetNpcFlagTrue {Name = "npc_sP200Figure9477Tot"},
