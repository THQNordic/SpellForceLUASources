-----------------------------------------------------------------------
--
--	P200Collosseum_CutszeneGoblinRennenGelb
--
-----------------------------------------------------------------------
...
n32201_CutszeneGoblinRennenCamera7 = 
[[
  	Camera:ScriptReset()
  	Camera:ScriptAddSpline(0,20,1,"script\\P200\\n32201_CutszeneGoblinRennenCamera7.lua")
   	Camera:ScriptStart()
]]
...
n32201_CutszeneGoblinRennenCamera11 = 
[[
  	Camera:ScriptReset()
  	Camera:ScriptAddSpline(0,20,1,"script\\P200\\n32201_CutszeneGoblinRennenCamera11.lua")
   	Camera:ScriptStart()
]]

CreateCutScene
{
	Name = "P200Collosseum_CutszeneGoblinRennenGelb", CameraScript = "", PlayOnlyOnce = TRUE,
	...
	BeginConditions =
	{
		...
		IsGlobalFlagTrue{Name = "g_sP200CutszeneGelbStart"},
	},
	BeginActions =
	{
	...
	{	
		...
		[400] =
		{
			ExecuteCameraScript{Script = n32201_CutszeneGoblinRennenCamera7},	
			WaitForEndOfSpeech,	 --sollte immer angegeben werden
		...
		[685] =
		{
			...
			WaitForEndOfSpeech,	 --sollte immer angegeben werden
			CutSceneSay {Tag = "csa230racemaster_005" , NpcId = 11416, String = "Da! Der Gelbe Grunzer geht in Führung! Ja, ein starker Läufer für die gelbe Fraktion..."},						
			PlaySound{Sound = SoundColosseumCheers},
			PlaySound{Sound = SoundColosseumApplause},
		},		
		[800] =
		...
		[850] =
		{
			ExecuteCameraScript{Script = n32201_CutszeneGoblinRennenCamera11},
			PlaySound{Sound = SoundColosseumCheers},				
		},
		[950] =
		{
		...
		[1050] =
		{
			...
			WaitForEndOfSpeech,	 --sollte immer angegeben werden
			CutSceneSay {Tag = "csa230racemaster_006" , NpcId = 11416, String = "Und er ist der Sieger! Sieg für diue gelbe Fraktion!"},		
			PlaySound{Sound = SoundColosseumApplause},
		},	
		[1150] =
		{
