...
SpawnOnlyWhen
{
	...
	Actions = 
	{
		SetGlobalFlagTrue {Name = "g_sP200Round8Monster3Gesetzt"},
...
Umspawn
{
	...
	Conditions = 
	{
		IsGlobalFlagTrue {Name = "g_sP200Round8Monster3Gesetzt"},
		IsGlobalFlagTrue {Name = "g_sP200Round7Solved"},
	...
	Actions = 
	{
		...
		SetGlobalFlagTrue {Name = "g_sP200ReadytoStartRound8Monster3"},
	}
}
...
Despawn
{
	...
	Actions = 
	{
		SetNpcFlagTrue {Name = "npc_sP200Figure9639Tot"},
	}
}
...
Respawn
{
	...
	Conditions = 
	{
		IsNpcFlagTrue {Name = "npc_sP200Figure9639Tot", UpdateInterval = 10},	
	...
	Actions = 
	{
		SetNpcFlagFalse {Name = "npc_sP200Figure9639Tot"},
