...
Respawn
{
	...
	Actions = 
	{
		Follow {Target = NpcId, NpcId = 10535},
		Follow {Target = NpcId, NpcId = 10536},
		Follow {Target = NpcId, NpcId = 10537},
		Follow {Target = NpcId, NpcId = 10538},
	}
}
...
OnAttackPattern
{
	Name = "5H_A",			-- muss unique sein, sollte kurz sein...
	PatternAlpha = 
	{
