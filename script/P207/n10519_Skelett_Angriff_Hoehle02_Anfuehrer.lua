...
--			Actions = 
--			{
--				Follow {Target = NpcId, NpcId = 10520},
--				Follow {Target = NpcId, NpcId = 10521},
--				Follow {Target = NpcId, NpcId = 10522},
--				Follow {Target = NpcId, NpcId = 10523},
--			}
--		}
...
OnAttackPattern
{
	Name = "2H_A",			-- muss unique sein, sollte kurz sein...
	PatternAlpha = 
	{
