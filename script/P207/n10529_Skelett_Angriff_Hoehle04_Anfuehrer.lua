...
--			Actions = 
--			{
--				Follow {Target = NpcId, NpcId = 10530},
--				Follow {Target = NpcId, NpcId = 10531},
--				Follow {Target = NpcId, NpcId = 10532},
--				Follow {Target = NpcId, NpcId = 10533},
--			}
--		}
...
OnAttackPattern
{
	Name = "4H_A",			-- muss unique sein, sollte kurz sein...
	PatternAlpha = 
	{
