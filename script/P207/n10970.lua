...
-- Source: C:\project\main\mission\dialoge\P207\n10970_Dritte_Festung_Schalter_Fuenf.txt
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "", String = ""},
			Answer{Tag = "lever05P207_003PC", String = "(Ein Knirschen ist zu hören.)", AnswerId = 3},
		}}
	...
	OnAnswer{3;
		...
		Actions = {
			Say{Tag = "", String = ""},
			Answer{Tag = "lever05P207_004PC", String = "(Die Ausgangstore der Festung öffnen sich.)", AnswerId = 4},
		}}
