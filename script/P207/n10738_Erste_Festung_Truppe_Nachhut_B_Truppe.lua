...
SpawnOnlyWhen
{
	...
	Conditions = 
	{
		--UND
		--(
		--IsGlobalFlagTrue {Name = "g_p207_Erste_Festung_Truppe_O_Dead"},
		--IsGlobalFlagTrue {Name = "g_p207_Erste_Festung_Truppe_O_Spawned"}
		--),
...
OnIdleEvent
{
	Conditions = 
	{
		FigureAlive {NpcId = 10738},  -- Anführer lebt noch
...
OnIdleGoHome
{
	...
	Conditions = 
	{
		FigureDead{NpcId = 10738},		
	},  
	Actions = 
	{
		StopFollow{Target = 10738},
	}
}
