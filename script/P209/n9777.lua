...
SpawnOnlyWhen
{
	...
	Actions =
	{
		Goto {X = 376, Y = 253, NpcId = self, Range = 3, WalkMode = Run, GotoMode = GotoForced},
	}
}
...
OnOneTimeEvent
{
	...
	Actions = 
	{ 
		Goto {X = 413, Y = 281, NpcId = self, Range = 0, WalkMode = Run, GotoMode = GotoForced},
	}
}
...
OnOneTimeEvent
{
	Conditions = 
	{ 
		FigureInRange {X = 413, Y = 281, NpcId = self, Range = 0},
