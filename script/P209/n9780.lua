...
SpawnOnlyWhen
{
	...
	Actions =
	{
		Goto {X = 374, Y = 249, NpcId = self, Range = 3, WalkMode = Run, GotoMode = GotoForced},
	}
}
...
OnOneTimeEvent
{
	...
	Actions = 
	{ 
		Goto {X = 324, Y = 182, NpcId = self, Range = 0, WalkMode = Run, GotoMode = GotoForced},
	}
}
...
OnOneTimeEvent
{
	Conditions = 
	{ 
		FigureInRange {X = 324, Y = 182, NpcId = self, Range = 0},
