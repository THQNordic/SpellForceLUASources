...
SpawnOnlyWhen
{
	...
	Actions =
	{
		Goto {X = 372, Y = 249, NpcId = self, Range = 3, WalkMode = Run, GotoMode = GotoForced},
	}
}
...
OnOneTimeEvent
{
	...
	Actions = 
	{ 
		Goto {X = 359, Y = 391, NpcId = self, Range = 0, WalkMode = Run, GotoMode = GotoForced},
	}
}
...
OnOneTimeEvent
{
	Conditions = 
	{ 
		FigureInRange {X = 359, Y = 391, NpcId = self, Range = 0},
