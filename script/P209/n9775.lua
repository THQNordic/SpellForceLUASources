...
SpawnOnlyWhen
{
	...
	Actions =
	{
		Goto {X = 372, Y = 253, NpcId = self, Range = 3, WalkMode = Run, GotoMode = GotoForced},
	}
}
...
OnOneTimeEvent
{
	...
	Actions = 
	{ 
		Goto {X = 352, Y = 395, NpcId = self, Range = 0, WalkMode = Run, GotoMode = GotoForced},
	}
}
...
OnOneTimeEvent
{
	Conditions = 
	{ 
		FigureInRange {X = 352, Y = 395, NpcId = self, Range = 0},
