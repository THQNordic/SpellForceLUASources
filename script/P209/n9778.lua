...
SpawnOnlyWhen
{
	...
	Actions =
	{
		Goto {X = 378, Y = 253, NpcId = self, Range = 3, WalkMode = Run, GotoMode = GotoForced},
	}
}
...
OnOneTimeEvent
{
	...
	Actions = 
	{ 
		Goto {X = 400, Y = 256, NpcId = self, Range = 0, WalkMode = Run, GotoMode = GotoForced},
	}
}
...
OnOneTimeEvent
{
	Conditions = 
	{ 
		FigureInRange {X = 400, Y = 256, NpcId = self, Range = 0},
