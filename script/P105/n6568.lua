...
-- Source: C:\Project\main\mission\dialoge\P105\n6568_Mordquest_Lithere.txt
	...
	OnBeginDialog{
		...
		Actions = {
			...
			OfferAnswer{Tag = "lithere105_005PC", String = "Erzählt mir, was sich zugetragen hat.", AnswerId = 3},
			OfferAnswer{Tag = "lithere105_013PC", String = "Erzählt mir etwas über Fennair.", AnswerId = 9},
			OfferAnswer{Tag = "lithere105_015PC", String = "Erzählt mir etwas über Baetha.", AnswerId = 10},
			OfferAnswer{Tag = "lithere105_017PC", String = "Erzählt mir etwas über Euch.", AnswerId = 11},
			OfferAnswer{Tag = "lithere105_021PC", String = "Danke. Lebt wohl.", AnswerId = 14},
		}}
	...
	OnAnswer{7;
		...
		Actions = {
			...
			Answer{Tag = "lithere105_011PC", String = "Woher wollt Ihr dann wissen, dass Baetha sie ins Tal gestoßen hat?", AnswerId = 8},
		}}
