...
Respawn
{
	X = 362, Y = 124, NoSpawnEffect = FALSE, WaitTime = 20, UnitId = 1895,
	Conditions = 
	{ 
		IsNpcCounter{Name = "ElementalRespawn", Value = 0, Operator = IsEqual},
		BuildingInRange {X = 365, Y = 124, Range = 0}
	},
	Actions = 
	{
...
Respawn
{
	X = 362, Y = 124, NoSpawnEffect = FALSE, WaitTime = 30, UnitId = 1896,
	Conditions = 
	{ 
...
Respawn
{
	X = 362, Y = 124, NoSpawnEffect = FALSE, WaitTime = 40, UnitId = 1897,
	Conditions = 
	{ 
