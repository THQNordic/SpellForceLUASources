...
-- Source: C:\Project\main\mission\dialoge\P105\n6567_Mordquest_Baetha.txt
	...
	OnBeginDialog{
		...
		Actions = {
			...
			OfferAnswer{Tag = "baetha105_004PC", String = "Erzählt mir, was sich zugetragen hat.", AnswerId = 2},
			OfferAnswer{Tag = "baetha105_012PC", String = "Erzählt mir etwas über Fennair.", AnswerId = 9},
			OfferAnswer{Tag = "baetha105_015PC", String = "Erzählt mir etwas über Lithere.", AnswerId = 11},
			OfferAnswer{Tag = "baetha105_018PC", String = "Erzählt mir etwas über Euch.", AnswerId = 13},
			OfferAnswer{Tag = "baetha105_021PC", String = "Ich habe keine Fragen mehr. Habt Dank.", AnswerId = 15},
		}}
