...
Respawn
{
	X = 344, Y = 340, NoSpawnEffect = FALSE, WaitTime = 120,
	Conditions = 
	{ 
...
Respawn
{
	X = 331, Y = 354, NoSpawnEffect = FALSE, WaitTime = 130,
	Conditions = 
	{ 
...
Respawn
{
	X = 339, Y = 318, NoSpawnEffect = FALSE, WaitTime = 140,
	Conditions = 
	{ 
		Negated(BuildingInRange {X = 344, Y = 340, Range = 0}),
...
Respawn
{
	X = 334, Y = 322, NoSpawnEffect = FALSE, WaitTime = 150,
	Conditions = 
	{ 
		Negated(BuildingInRange {X = 344, Y = 340, Range = 0}),
		Negated(BuildingInRange {X = 331, Y = 354, Range = 0}),
