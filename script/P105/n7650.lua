...
Respawn
{
	X = 349, Y = 128, NoSpawnEffect = FALSE, WaitTime = 20, UnitId = 1895,
	Conditions = 
	{ 
		IsNpcCounter{Name = "ElementalRespawn", Value = 0, Operator = IsEqual},
		BuildingInRange {X = 349, Y = 128, Range = 0}
	},
	Actions = 
	{
...
Respawn
{
	X = 349, Y = 128, NoSpawnEffect = FALSE, WaitTime = 30, UnitId = 1896,
	Conditions = 
	{ 
...
Respawn
{
	X = 349, Y = 128, NoSpawnEffect = FALSE, WaitTime = 40, UnitId = 1897,
	Conditions = 
	{ 
