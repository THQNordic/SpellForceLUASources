...
OnOneTimeEvent
{
	...
	Conditions = 
	{ 
		IsGlobalTimeElapsed{Name = "AbSpielerHatQuestarmee", Seconds = 70, UpdateInterval = 60},
...
Umspawn
{
	...
	Actions = 
	{ 
	Goto {X = 292, Y = 94, NpcId = self , Range = 3 , WalkMode = Walk , GotoMode = GotoNormal , XRand = 0 , YRand = 0},
	},
}
