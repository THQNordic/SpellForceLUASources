...
OnOneTimeEvent
{
	...
	Conditions = 
	{ 
		IsGlobalTimeElapsed{Name = "AbSpielerHatQuestarmee", Seconds = 110, UpdateInterval = 60},
...
Umspawn
{
	...
	Actions = 
	{ 
	Goto {X = 295, Y = 111, NpcId = self , Range = 5 , WalkMode = Walk , GotoMode = GotoNormal , XRand = 0 , YRand = 0},
	},
}
