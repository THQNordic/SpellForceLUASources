...
Umspawn
{
	...
	Conditions = 
	{
		...
		ODER (ODER (IsGlobalCounter { Name = "g_cnP201Mitstreiter", Operator = IsEqual, Value = 3, UpdateInterval = 10}, IsGlobalCounter { Name = "g_cnP201Mitstreiter", Operator = IsEqual, Value = 2, UpdateInterval = 10}),
			 ODER (IsGlobalCounter { Name = "g_cnP201Mitstreiter", Operator = IsEqual, Value = 1, UpdateInterval = 10}, IsGlobalCounter { Name = "g_cnP201Mitstreiter", Operator = IsEqual, Value = 1, UpdateInterval = 10}))
	},
	Actions =
	{
