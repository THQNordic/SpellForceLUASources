...
SpawnOnlyWhen
{
	...
	Actions = 
	{
		...
		SetHealth{HitPoints = 1, NpcId = self, Decrease = FALSE},
 		SetGlobalFlagTrue {Name = "g_P201LaurinDoppelgaenger4lebt"},
	}
} 
...
OnOneTimeEvent
{
	...
	{ 
		...
		IsGlobalFlagFalse {Name = "g_sP201_LaurinStein4Off", UpdateInterval = 10},
	},
	Actions = 
	{ 
...
OnOneTimeEvent
{
	...
	{ 
		...
		IsGlobalFlagTrue {Name = "g_sP201LaurinAmLeben", UpdateInterval = 10},
		--IsGlobalFlagFalse {Name = "g_sP201LaurinTot"},	
		IsGlobalFlagTrue {Name = "g_sP201_LaurinStein4Off", UpdateInterval = 10},
		IsGlobalFlagTrue {Name = "g_P201LaurinDoppelgaenger4lebt", UpdateInterval = 10},
	},
	Actions = 
	{ 
		ChangeRace {Race = 107, NpcId = self},
