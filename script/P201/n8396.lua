...
Respawn 
{
	...
	NoSpawnEffect = FALSE ,
 	Conditions = 
 	{
 		Negated(FigureInRangeNpc {TargetNpcId = 8399, NpcId = 0, Range = 20, UpdateInterval = 10}),
...
OnIdleEvent
{
	Conditions = 
	{ 
		IsGlobalCounter {Name = "g_cnP201OrdensritterStart3", Value = 0, Operator = IsEqual, UpdateInterval = 60},
	},
	Actions = 
	{ 
		Goto {X = _X, Y = _Y, NpcId = self, Range = 5, WalkMode = Run, GotoMode = GotoForced},
