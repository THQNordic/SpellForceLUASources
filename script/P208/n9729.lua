...
SpawnOnlyWhen
{
	...
	Conditions =
	{
		...
		IsGlobalFlagTrue {Name = "g_GoblinEinsGruppeZweiTot"},
...
Respawn
{
	...
	{
		-- Wenn der gegenpart am Fleisch ist wird gespant
		IsGlobalFlagTrue {Name = "g_GoblinEinsGruppeZweiTot", UpdateInterval = 5},
	},
}
...
Despawn
{
	...
	Actions = 
	{
		SetGlobalFlagFalse {Name = "g_GoblinEinsGruppeZweiTot"}
	}
}
