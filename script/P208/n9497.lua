...
OnOneTimeEvent
{
	...
	Actions =
	{
		...
		Outcry {Tag = "oca2jylaP208_002", NpcId = 9497, String = "Wir verlassen Euch nun! Viel Glück auf Eurer Reise!", Color = ColorWhite}, 
	}
}
...
-- Source: C:\Project\main\mission\dialoge\p208\n9497_PrinzessinVier.txt
	...
	OnBeginDialog{
		...
		Actions = {
			Say{Tag = "princess4P208_001", String = "(Die hässliche Kreatur schaut Euch mit großen Augen flehend an.)"},
