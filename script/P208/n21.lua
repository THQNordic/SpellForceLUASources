...
Conditions = {},
Actions = {PlaySound{Sound = SoundVolcanoGrumble}}
}
...
{ 
	...
	Conditions = 
	{
		IsNpcTimeElapsed{Name = "PlaySoundTimer", Seconds = 20, UpdateInterval = 2},
	},
	Actions = 
	{
	PlaySound{Sound = SoundVolcanoGrumble},
...
{ 
	...
	Conditions = 
	{
		IsNpcTimeElapsed{Name = "PlaySoundTimer", Seconds = 12, UpdateInterval = 2},
	},
	Actions = 
	{
	PlaySound{Sound = SoundVolcanoGrumble},
...
{ 
	...
	Conditions = 
	{
		IsNpcTimeElapsed{Name = "PlaySoundTimer", Seconds = 31, UpdateInterval = 2},
	},
	Actions = 
	{
	PlaySound{Sound = SoundVolcanoGrumble},
...
{ 
	...
	Conditions = 
	{
		IsNpcTimeElapsed{Name = "PlaySoundTimer", Seconds = 18, UpdateInterval = 2},
	},
	Actions = 
	{
	PlaySound{Sound = SoundVolcanoGrumble},
...
{ 
	...
	Conditions = 
	{
		IsNpcTimeElapsed{Name = "PlaySoundTimer", Seconds = 39, UpdateInterval = 2},
	},
	Actions = 
	{
	PlaySound{Sound = SoundVolcanoGrumble},
...
{ 
	...
	Conditions = 
	{
		IsNpcTimeElapsed{Name = "PlaySoundTimer", Seconds = 24, UpdateInterval = 2},
	},
	Actions = 
	{
