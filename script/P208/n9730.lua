...
SpawnOnlyWhen
{
	...
	Conditions =
	{
		...
		IsGlobalFlagTrue {Name = "g_GoblinZweiGruppeZweiTot"},
...
Respawn
{
	...
	{
		-- Wenn der gegenpart am Fleisch ist wird gespant
		IsGlobalFlagTrue {Name = "g_GoblinZweiGruppeZweiTot", UpdateInterval = 5},
	},
}
...
Despawn
{
	...
	Actions = 
	{
		SetGlobalFlagFalse {Name = "g_GoblinZweiGruppeZweiTot"}
	}
}
