...
SpawnOnlyWhen
{
	...
	Conditions =
	{
		...
		IsGlobalFlagTrue {Name = "g_GoblinDreiGruppeDreiTot"},
...
Respawn
{
	...
	{
		-- Wenn der gegenpart am Fleisch ist wird gespant
		IsGlobalFlagTrue {Name = "g_GoblinDreiGruppeDreiTot", UpdateInterval = 5},
...
Despawn
{
	...
	Actions = 
	{
		SetGlobalFlagFalse {Name = "g_GoblinDreiGruppeDreiTot"}
	}
}
