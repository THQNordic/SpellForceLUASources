...
SpawnOnlyWhen
{
	...
	Conditions =
	{
		...
		IsGlobalFlagTrue {Name = "g_GoblinDreiGruppeEinsTot"},
		
	},
	Actions =
	{
		SetGlobalFlagFalse {Name = "g_GoblinDreiGruppeEinsTot"},
	}
}
...
Respawn
{
	...
	{
		-- Wenn der gegenpart am Fleisch ist wird gespant
		IsGlobalFlagTrue {Name = "g_GoblinDreiGruppeEinsTot", UpdateInterval = 5},
	},
	Actions =
	{
		SetGlobalFlagFalse {Name = "g_GoblinDreiGruppeEinsTot"},
