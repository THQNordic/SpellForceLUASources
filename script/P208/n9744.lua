...
SpawnOnlyWhen
{
	...
	Conditions =
	{
		...
		IsGlobalFlagTrue {Name = "g_GoblinZweiGruppeVierTot"},
...
Respawn
{
	...
	{
		-- Wenn der gegenpart am Fleisch ist wird gespant
		IsGlobalFlagTrue {Name = "g_GoblinZweiGruppeVierTot", UpdateInterval = 5},
	},
}
...
Despawn
{
	...
	Actions = 
	{
		SetGlobalFlagFalse {Name = "g_GoblinZweiGruppeVierTot"}
	}
}
