...
OnIdleGoHome
{       
	X = 364, Y = 200, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 180, Y = 250, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 262, Y = 233, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 300, Y = 255, Direction = random(0,7), Range = 2,
	Conditions =
	{
