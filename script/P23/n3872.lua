...
OnIdleGoHome
{       
	X = 152, Y = 270, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 147, Y = 295, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 307, Y = 232, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 117, Y = 258, Direction = random(0,7), Range = 2,
	Conditions =
	{
