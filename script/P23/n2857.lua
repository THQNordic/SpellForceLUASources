...
OnIdleGoHome
{       
	X = 299, Y = 233, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 194, Y = 237, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 129, Y = 263, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 167, Y = 267, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	...
	HomeActions =
	{
		...
		SetGlobalTimeStamp {Name = "WegpunktZaehler"},
	}
}
