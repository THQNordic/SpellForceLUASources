...
OnIdleGoHome
{       
	X = 147, Y = 244, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 146, Y = 296, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 183, Y = 263, Direction = random(0,7), Range = 2,
	Conditions =
	{
...
OnIdleGoHome
{
	X = 152, Y = 289, Direction = random(0,7), Range = 2,
	Conditions =
	{
