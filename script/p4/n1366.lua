...
Conditions = 	{
	...
	Actions =	
	{
		...
		SetPlayerFlagTrue{Name = "Elf1366Freed"},
		TransferItem{GiveItem = 2458 , Flag = Give},
...
REM = [[
--!EDS PATROL BEGIN
AddGotoLocation{X = 424, Y = 121, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 418, Y = 121, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 375, Y = 120, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 358, Y = 132, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 352, Y = 171, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 370, Y = 199, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 362, Y = 224, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 330, Y = 251, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 297, Y = 285, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 266, Y = 323, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 244, Y = 334, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 226, Y = 315, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 204, Y = 293, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 205, Y = 264, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 174, Y = 238, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 168, Y = 199, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 162, Y = 163, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 137, Y = 167, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 111, Y = 169, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 101, Y = 162, Range = 2 , WalkMode = Run}
AddGotoLocation{X = 100, Y = 156, Range = 2 , WalkMode = Run}
--!EDS PATROL END
---Elfe läuft nach Eloni nach Dialog
OnIdleWalkPath
{
Loop = FALSCH , 
UpdateInterval = 60, 
Conditions = {IsNpcFlagTrue{Name = "FreeElfRunToEloni"}},	
}
]]
