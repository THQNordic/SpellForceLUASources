...
Respawn
{
	X = 77, Y = 307, NoSpawnEffect = FALSE, WaitTime = 223,
	Conditions = 
	{ 
	...
	Actions = 
	{
		Follow {Target = NpcId, NpcId = 8757},
		Follow {Target = NpcId, NpcId = 8762},
		Follow {Target = NpcId, NpcId = 8781},
		Follow {Target = NpcId, NpcId = 8782},
		Follow {Target = NpcId, NpcId = 8783},
	}
}
...
OnAttackPattern
{
	Name = "4AP1_TRO",			-- muss unique sein, sollte kurz sein...
	PatternAlpha = 
	{
	...
	PatternDelta = 
	{
		...
		[1] = {X = g_P206_SeelensteinX, Y = g_P206_SeelensteinY, WalkMode = Run, Direction = East},
		[2] = {X = g_P206_DritterStreunerWPX, Y = g_P206_DritterStreunerWPY, WalkMode = Run, Direction = East},
	...
	CommonGoal = {X = g_P206_VierterTrokanX, Y = g_P206_VierterTrokanY, WalkMode = Run, GuardTime = 30},
}

-- Wenn Trokan tot ist werden die Jungs in Trakans Lager angegriffen
OnAttackPattern
{
	Name = "4AP2_TRO",			-- muss unique sein, sollte kurz sein...
	PatternAlpha = 
	{
