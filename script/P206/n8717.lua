...
-- Der Unterhändler hat Trakan auf den Berg geschickt
OnIdleGoHome
{
	X = 265, Y = 250, WalkMode = Run, Direction = 0,
		Conditions =
	{
...
Despawn
{
	...
	Conditions =
	{
		--ODER
		--(
			IsNpcFlagTrue {Name = "n_P206_Sterben"},
		--	QuestState {QuestId = 886, State = StateActive}
		--)
	},
	Actions =
	{
			SetGlobalFlagTrue {Name = "g_P206_UnKillTrakanTot"}
	}
	
}

-- Zeitverzögerung, damit die Figur nicht zu früh als tot gilt
OnOneTimeEvent
{
	Conditions =
	{
