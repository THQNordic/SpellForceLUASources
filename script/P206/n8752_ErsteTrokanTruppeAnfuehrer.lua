...
Respawn
{
	X = g_P206_ErsterTrokanX, Y = g_P206_ErsterTrokanY, NoSpawnEffect = TRUE, WaitTime = 275,
	Conditions = 
	{ 
	...
	Actions = 
	{
		Follow {Target = NpcId, NpcId = 8770},
		Follow {Target = NpcId, NpcId = 8780},
		Follow {Target = NpcId, NpcId = 8760},
		Follow {Target = NpcId, NpcId = 8768},
		Follow {Target = NpcId, NpcId = 8779},
		Follow {Target = NpcId, NpcId = 8775},
		Follow {Target = NpcId, NpcId = 8769},
	}
}
...
OnAttackPattern
{
	Name = "AP1_TRO",			-- muss unique sein, sollte kurz sein...
	PatternAlpha = 
	{
...
OnAttackPattern
{
	Name = "AP2_TRO",			-- muss unique sein, sollte kurz sein...
	PatternAlpha = 
	{
		Retries = 2,		-- so oft hintereinander diesen angriffsweg nehmen
		GuardTime = 10,		-- sekunden die an jedem punkt gewartet werden
