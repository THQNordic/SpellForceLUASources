...
Respawn
{
	X = g_P206_ZweiterTrakanX, Y = g_P206_ZweiterTrakanY, NoSpawnEffect = TRUE, WaitTime = 250,
	Conditions = 
	{ 
	...
	Actions = 
	{
		Follow {Target = NpcId, NpcId = 8743},
		Follow {Target = NpcId, NpcId = 8741},
		Follow {Target = NpcId, NpcId = 8742},
		Follow {Target = NpcId, NpcId = 8746},
		Follow {Target = NpcId, NpcId = 8747},
	}
}
...
OnAttackPattern
{
	Name = "2AP1_TRA",			-- muss unique sein, sollte kurz sein...
	PatternAlpha = 
	{
...
OnAttackPattern
{
	Name = "2AP2_TRA",			-- muss unique sein, sollte kurz sein...
	PatternAlpha = 
	{
		Retries = 2,	
		GuardTime = 10,	
	...
	PatternDelta = 
	{
		Retries = 1,	
		GuardTime = 10,
		[1] = {X = g_P206_DritterTrokanX, Y = g_P206_DritterTrokanY, WalkMode = Run, Direction = East},
	...
	PatternOmega = 
	{
		...
		[2] = {X = g_P206_OestlicherLagereingangX, Y = g_P206_OestlicherLagereingangY, WalkMode = Run, Direction = East},
		[3] = {X = g_P206_VierterTrokanX, Y = g_P206_VierterTrokanY, WalkMode = Run, Direction = East},
	},
	CommonGoal = {X = g_P206_ZweiterTrakanX, Y = g_P206_ZweiterTrakanY, WalkMode = Run, GuardTime = 30},
}
