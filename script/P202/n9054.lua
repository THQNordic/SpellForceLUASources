...
SpawnOnlyWhen
{
	...
	{ 
		...
		--IsGlobalTimeElapsed { Name = "g_nP202_TimerEckenSpawning", Seconds = 140, UpdateInterval = 10 },
	} , 
	Actions = 
	{ 
...
Respawn
{
	WaitTime = 50, UnitId = self , Clan = 0 , Target = none , X = 295, Y = 278 , Chief = none, NoSpawnEffect = FALSE , 
	Conditions = 
	{ 
		--IsGlobalFlagFalse{Name = "g_P202Spawnpunktebesetzt", UpdateInterval = 30},
		IsGlobalFlagFalse {Name = "g_P202Punkt2Besetzt", UpdateInterval = 10},
