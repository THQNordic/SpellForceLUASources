...
SpawnOnlyWhen
{
	...
	Conditions = 
	{
		IsGlobalFlagTrue {Name = "g_P202BergkristallGolemGewaehlt", UpdateInterval = 2},
	...
	Actions = 
	{
		...
		TransferItem {TakeItem = 7074, GiveItem = 0, Amount = 1, Flag = Take}
	}
}

--Respawn, bis Tor auf oder türme weg
Respawn
{
