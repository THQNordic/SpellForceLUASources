...
SpawnOnlyWhen
{
	...
	{ 
		...
		--IsGlobalTimeElapsed { Name = "g_nP202_TimerEckenSpawning", Seconds = 15, UpdateInterval = 10 },
	} , 
	Actions = 
	{ 
...
Respawn
{
	WaitTime = 110, UnitId = self, Clan = 0, Target = none, X = 373, Y = 337, Chief = none, NoSpawnEffect = FALSE , 
	Conditions = 
	{ 
		IsGlobalFlagFalse {Name = "g_P202Punkt1Besetzt", UpdateInterval = 10},
	} , 
