...
SpawnOnlyWhen
{
	...
	{ 
		...
		--IsGlobalTimeElapsed { Name = "g_nP202_TimerEckenSpawning", Seconds = 160, UpdateInterval = 10 },
	} , 
	Actions = 
	{ 
...
Respawn
{
	WaitTime = 60, UnitId = self , Clan = 0 , Target = none , X = 323 , Y = 193 , Chief = none, NoSpawnEffect = FALSE , 
	Conditions = 
	{ 
		--IsGlobalFlagFalse{Name = "g_P202Spawnpunktebesetzt", UpdateInterval = 30},
		IsGlobalFlagFalse {Name = "g_P202Punkt3Besetzt", UpdateInterval = 10},
...
--	Conditions =
--	{
--		FigureInRange {X = 360, Y = 238, NpcId = self , Range = 5},
--		
--	},
--	Actions = 
--	{
