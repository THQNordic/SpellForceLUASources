...
SpawnOnlyWhen
{
	...
	{ 
		...
		--IsGlobalTimeElapsed { Name = "g_nP202_TimerEckenSpawning", Seconds = 90, UpdateInterval = 10 },
	} , 
	Actions = 
	{ 
...
Respawn
{
	WaitTime = 300, UnitId = self, Clan = 0, Target = none, X = 373, Y = 337, Chief = none, NoSpawnEffect = FALSE, 
	Conditions = 
	{ 
		--IsGlobalFlagFalse{Name = "g_P202Spawnpunktebesetzt", UpdateInterval = 30},
		IsGlobalFlagFalse {Name = "g_P202Punkt1Besetzt", UpdateInterval = 10},
...
--	Conditions =
--	{
--		FigureInRange {X = 375, Y = 265, NpcId = self , Range = 2},
--		
--	},
--	Actions = 
--	{
