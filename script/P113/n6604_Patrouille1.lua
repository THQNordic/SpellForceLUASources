...
OnIdleGoHome
{
	X = 359, Y = 200, Direction = 5, Range = 5 , WalkRange = 10 , WaitTime = 0 , WalkMode = Walk , GotoMode = GotoNormal,
	Conditions = 
	{  
...
--	Actions = 
--	{
--		IncreaseGlobalCounter{Name = "P113CTruppePatrol1", Step = 1},
--	}
--}
-- 
-- 
...
--		FigureInRange{X = _X, Y = _Y, NpcId = 6612 , Range = 7},
--	} , 
--	Actions = { } , 
--	DeathActions = { }, 
--
