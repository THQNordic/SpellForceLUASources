...
OnOneTimeEvent
{
	...
	Actions =
	{
		...
		SetEffect {Effect = "BuildingFire", Length = 150, TargetType = Figure},
		SetNpcTimeStamp {Name = "n_P203_Stirb"},
		Goto {X = 474, Y = 385, WalkMode = Run, GotoMode = GotoForced}
	}
}
...
OnOneTimeEvent
{
	...
	Conditions =
	{
		IsNpcTimeElapsed {Name = "n_P203_Stirb", Seconds = 5, UpdateInterval = 2},
	},
	Actions =
	{
		Kill {},
