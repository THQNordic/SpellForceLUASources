...
-- Source: C:\project\main\mission\dialoge\p213\n11266_Schaedelkiste2.txt
	...
	OnBeginDialog{
		...
		Actions = {
			Say{Tag = "skullbox2P212_001", String = "(Anstelle eines Schlüssellochs ist in diese Kiste ein Schlitz eingelassen. Daneben wurden fünf Totenschädel in das Holz geschnitzt.)"},
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "skullbox2P212_002PC", String = "(Schädelmünze in den Schlitz werfen)", AnswerId = 3},
		}}
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "skullbox2P212_004", String = "(Die Münze fällt in den Schlitz. In der Truhe verschiebt sich ein Riegel.)"},
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "skullbox2P212_003", String = "(Die Münze fällt in den Schlitz. Der letzte Riegel verschiebt sich. Die Truhe kann jetzt geöffnet werden.)"},
