...
-- Source: C:\project\main\mission\dialoge\p213\n11267_Schaedelkiste3.txt
	...
	OnBeginDialog{
		...
		Actions = {
			Say{Tag = "skullbox3P213_001", String = "(Anstelle eines Schlüssellochs ist in diese Kiste ein Schlitz eingelassen. Daneben wurden fünf Totenschädel in das Holz geschnitzt.)"},
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "skullbox3P213_002PC", String = "(Schädelmünze in den Schlitz werfen)", AnswerId = 3},
		}}
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "skullbox3P213_004", String = "(Die Münze fällt in den Schlitz. In der Truhe verschiebt sich ein Riegel.)"},
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "skullbox3P213_003", String = "(Die Münze fällt in den Schlitz. Der letzte Riegel verschiebt sich. Die Truhe kann jetzt geöffnet werden.)"},
