...
OnOneTimeEvent
{
	Conditions =
	{
		FigureHasHealth {NpcId = 11190, Percent = 73, UpdateInterval = 2},
	},
	Actions =
	{
		Outcry {Tag = "oca2iannaP213_001", NpcId = 9925, String = "Ich werde im Totenreich auf Euch warten!", Color = ColorWhite},
