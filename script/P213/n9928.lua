...
OnOneTimeEvent
{
	Conditions =
	{
		FigureHasHealth {NpcId = 11190, Percent = 46, UpdateInterval = 2},
	},
	Actions =
	{
		Outcry {Tag = "oca2sharP213_001", NpcId = 9928, String = "Nicht wieder ins graue Reich! Nein!", Color = ColorWhite}, 
