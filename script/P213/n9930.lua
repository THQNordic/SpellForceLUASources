...
OnOneTimeEvent
{
	Conditions =
	{
		FigureHasHealth {NpcId = 11190, Percent = 28, UpdateInterval = 2},
	},
	Actions =
	{
		Outcry {Tag = "oca2silverhandP213_001", NpcId = 9930, String = "Nehmt nicht mein Leben, nein!", Color = ColorWhite},
