...
SpawnOnlyWhen
{
	...
	Conditions =
	{
		IsGlobalFlagTrue { Name = "Jonas Spawn" , UpdateInterval = 10 }
	},
	Actions =
	{	
		SetGlobalFlagTrue { Name = "Jonas Gespawnt" },
...
OnEvent
{
	Conditions =
	{
		TimeBetween { Hour = LibiEndStunde, Minute = 36, ToHour = 23, ToMinute = 59},
