...
SpawnOnlyWhen
{
	...
	Conditions =
	{
		IsGlobalFlagTrue { Name = "Volker Spawn" , UpdateInterval = 10 }
	},
	Actions =
	{	
		SetGlobalFlagTrue { Name = "Volker Gespawnt" },
...
OnEvent
{
	Conditions =
	{
		TimeBetween { Hour = LibiEndStunde, Minute = 54, ToHour = 23, ToMinute = 59},
