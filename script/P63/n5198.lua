...
SpawnOnlyWhen
{
	...
	Conditions =
	{
		IsGlobalFlagTrue { Name = "Steffen Spawn" , UpdateInterval = 10 }
	},
	Actions =
	{	
		SetGlobalFlagTrue { Name = "Steffen Gespawnt" },
...
OnEvent
{
	Conditions =
	{
		TimeBetween { Hour = LibiEndStunde, Minute = 8, ToHour = 23, ToMinute = 59},
