...
SpawnOnlyWhen
{
	...
	Conditions =
	{
		IsGlobalFlagTrue { Name = "Silke Spawn" , UpdateInterval = 10 }
	},
	Actions =
	{	
		SetGlobalFlagTrue { Name = "Silke Gespawnt" },
...
OnEvent
{
	Conditions =
	{
		TimeBetween { Hour = LibiEndStunde, Minute = 14, ToHour = 23, ToMinute = 59},
