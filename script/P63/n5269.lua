...
SpawnOnlyWhen
{
	...
	Conditions =
	{
		IsGlobalFlagTrue { Name = "Marco K Spawn" , UpdateInterval = 10 }
	},
	Actions =
	{	
		SetGlobalFlagTrue { Name = "Marco K Gespawnt" },
...
OnEvent
{
	Conditions =
	{
		TimeBetween { Hour = LibiEndStunde, Minute = 48, ToHour = 23, ToMinute = 59},
