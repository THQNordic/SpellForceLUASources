...
{
	UpdateInterval = 15,
	X = 323, Y = 257,		-- exact position of portal object!
	Type = EmpyriaTor,		-- type of portal
	OpenConditions = 
	{ 
		IsGlobalFlagTrue {Name = "g_P204_BasartorOstAufmachen", UpdateInterval = 60},
	},
	CloseConditions = {},
	StayOpen = TRUE,
	...
	OpenActions =
	{
		SetGlobalTimeStamp{Name = "c_P204_CounterBasartorOst"},	
		SetGlobalFlagTrue{Name = "g_P204_BasartorOstOffen"},
		SetGlobalFlagTrue{Name = "PleaseRemoveDialog_9999"},		
		QuestSolve {QuestId = 948},
		RemoveDialog {},
	}
}
...
-- Source: C:\project\main\mission\dialoge\P204\n9999_BasartorOst.txt
	...
	OnBeginDialog{
		Conditions = {
			Negated(IsGlobalFlagTrue{Name = "g_P204_BasartorOstBewacht"}),
		},
		Actions = {
			Say{Tag = "gate_basarsouth_001", String = "(Dieses Tor ist verschossen)"},
	...
	OnAnswer{3;
		...
		Actions = {
			SetGlobalTimeStamp{Name = "c_P204_CounterNasarSagtWas"}, SetGlobalFlagTrue{Name = "g_P204_BasartorOstAufmachen"},
			Say{Tag = "", String = ""},
