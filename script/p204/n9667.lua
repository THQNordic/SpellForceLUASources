...
-- Source: C:\project\main\mission\dialoge\P204\n9667_OberstadttorRechts.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "gate_upperrrightP204_002PC", String = "(Den Dietrich verwenden, obwohl die Wachen in der Nähe sind?)", AnswerId = 2},
		}}
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "gate_upperrrightP204_003", String = "(Das Tor öffnet sich.)"},
