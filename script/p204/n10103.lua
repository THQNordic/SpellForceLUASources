...
OnOneTimeEvent
{
	...
	Actions =
	{
	 	SetGlobalFlagTrue{Name = "PleaseRemoveDialog_10103"},
	}
}
...
OnOneTimeEvent
{
	...
	Actions =
	{
	 	SetGlobalFlagTrue{Name = "PleaseEnableSideQuestDialog_10103"},
	}
}
...
OnOneTimeEvent
{
	Conditions = 
	{
		IsGlobalFlagTrue{Name = "g_P204_Gauner1Kampf"},
	},
...
-- Source: C:\project\main\mission\dialoge\P204\n10103_Gauner.txt
	...
	OnBeginDialog{
		Conditions = {
			IsGlobalFlagTrue {Name = "g_P204_Gauner1HatVerkauft"},
		},
		Actions = {
			Say{Tag = "alchemistP204_001", String = "Ah, Ihr! Was gibt es?"},
			OfferAnswer{Tag = "alchemistP204_002PC", String = "Ich brauche mehr Traumstaub!", AnswerId = 1},
		}}

	OnBeginDialog{
		Conditions = {
			Negated(IsGlobalFlagTrue {Name = "g_P204_Gauner1HatVerkauft"}),
		},
		Actions = {
			Say{Tag = "", String = ""},
	...
	OnAnswer{2;
		Conditions = {
			IsNpcFlagTrue{Name = "NeverSetThisTrue"},
		},
		Actions = {
	...
	OnAnswer{2;
		Conditions = {
			Negated(IsNpcFlagTrue{Name = "NeverSetThisTrue"}),
		},
		Actions = {
			Say{Tag = "alchemistP204_005", String = "Beherrscht Euch! Ihr sucht wohl Streit?"},
			OfferAnswer{Tag = "alchemistP204_006PC", String = "Wenn ich dann an den Staub komme, ja, du Wanze!", AnswerId = 3},
	...
	OnAnswer{5;
		...
		Actions = {
			SetGlobalFlagTrue {Name = "g_P204_Gauner1Kampf"},
	...
	OnAnswer{11;
		Conditions = {
			IsGlobalFlagTrue {Name = "g_P204_Gauner1Angebot"},
		},
		Actions = {
			Say{Tag = "", String = ""},
	...
	OnAnswer{11;
		Conditions = {
			Negated(IsGlobalFlagTrue {Name = "g_P204_Gauner1Angebot"}),
		},
		Actions = {
	...
	OnAnswer{15;
		...
		Actions = {
			SetGlobalFlagTrue {Name = "g_P204_Gauner1Angebot"},
			Say{Tag = "", String = ""},
			Answer{Tag = "", String = "", AnswerId = 16},
		}}
	...
	OnAnswer{23;
		...
		Actions = {
			TransferMoney{Gold = 20, Flag = Take}, TransferItem {GiveItem = 7220, Flag = Give}, SetGlobalFlagTrue {Name = "g_P204_Gauner1HatVerkauft"},
			Say{Tag = "", String = ""},
