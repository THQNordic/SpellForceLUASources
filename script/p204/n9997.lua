...
OnPortalEvent
{
	...
	OpenConditions = 
	{ 
		IsGlobalFlagTrue {Name = "g_P204_BasartorSuedAufmachen", UpdateInterval = 60},
	},
	CloseConditions = {},
	StayOpen = TRUE,
	...
	OpenActions =
	{
		SetGlobalTimeStamp{Name = "c_P204_CounterBasartorSued"},
		SetGlobalFlagTrue {Name = "g_P204_BasartorSuedOffen"},
		SetGlobalFlagTrue{Name = "PleaseRemoveDialog_9997"},
		SetGlobalFlagTrue{Name = "PleaseRemoveDialog_8830"},
		QuestSolve {QuestId = 947},
		RemoveDialog {},
...
-- Source: C:\project\main\mission\dialoge\P204\n9997_BasartorSued.txt
	...
	OnBeginDialog{
		Conditions = {
			Negated(IsGlobalFlagTrue{Name = "g_P204_BasartorSuedBewacht"}),
		},
		Actions = {
			Say{Tag = "gate_basarsouth_001", String = "(Dieses Tor ist verschossen)"},
	...
	OnAnswer{3;
		...
		Actions = {
			SetGlobalTimeStamp{Name = "c_P204_CounterNasarSagtWas"}, SetGlobalFlagTrue{Name = "g_P204_BasartorSuedAufmachen"},
			Say{Tag = "", String = ""},
