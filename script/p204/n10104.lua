...
OnIdleGoHome
{
X = _X, Y = _Y, Direction = 2, Range = 0 , WalkRange = 2 , WaitTime = 0 , WalkMode = Run , GotoMode = GotoNormal,
	Conditions = {},
	Actions = {},
	HomeActions = 
	{
...
OnOneTimeEvent
{
	...
	Actions =
	{
	 	SetGlobalFlagTrue{Name = "PleaseRemoveDialog_10104"},
	}
}
...
OnOneTimeEvent
{
	...
	Actions =
	{
	 	SetGlobalFlagTrue{Name = "PleaseEnableSideQuestDialog_10104"},
	}
}
