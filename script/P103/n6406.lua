...
OnIdleGoHome
{
	X = 311 , Y = 365 , Direction = South , Range = 1 , WalkRange = 1 , WaitTime = 0 , WalkMode = Run , GotoMode = GotoContinuous,
	Conditions = 
	{
...
OnIdleGoHome
{
	X = 346 , Y = 219 , Direction = South , Range = 1 , WalkRange = 1 , WaitTime = 0 , WalkMode = Run , GotoMode = GotoContinuous,
	Conditions = { 
