...
OnToggleEvent 
{
	...
	OnConditions =
	{
		IsGlobalFlagTrue{Name = "P210Room9Stele02On", UpdateInterval = 15},
	},
	OnActions	=
	{
	...
	OffConditions =
	{
		IsGlobalFlagFalse{Name = "P210Room9Stele02On", UpdateInterval = 15},
	},
	OffActions	=
	{
...
-- Source: C:\project\main\mission\dialoge\p210\n10000_Raum9Stele2.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room9pillar2P210_001PC", String = "(Die Säule berühren)", AnswerId = 2},
		}}
	...
	OnAnswer{3;
		...
		Actions = {
			...
			FlipGlobalFlag { Name = "P210Room9Stele06On"},
			Say{Tag = "", String = ""},
