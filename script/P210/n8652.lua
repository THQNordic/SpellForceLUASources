...
-- Source: C:\project\main\mission\dialoge\p210\n8652_Raum2Fackel12.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room2_torch12_p210_001PC", String = "(Die Fackel entzünden.)", AnswerId = 2},
		}}
	...
	OnAnswer{3;
		...
		Actions = {
			SetEffect { Effect = "Torch",  Length = 2500, TargetType = Object, NpcId = self},
