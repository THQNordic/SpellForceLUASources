...
-- Source: C:\project\main\mission\dialoge\p210\n9908_SzepterKiste.txt
	...
	OnBeginDialog{
		...
		Actions = {
			Say{Tag = "sceptrechestp210_001", String = "(Im Deckel der Kiste ist ein Schlitz. Daneben wurde fünfmal das Symbol des Feuers in das Holz geritzt.)"},
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "sceptrechestp210_002PC", String = "(Feuermünze in den Schlitz werfen)", AnswerId = 3},
		}}
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "sceptrechestp210_004", String = "(Die Münze fällt in den Schlitz.)"},
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "sceptrechestp210_003", String = "(Ein Mechanismus im Inneren der Kiste klickt. Die Kiste kann jetzt geöffnet werden.)"},
