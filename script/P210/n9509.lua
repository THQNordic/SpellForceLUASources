...
OnToggleEvent 
{
	...
	OnConditions =
	{
		IsGlobalFlagTrue{Name = "g_P210Room1aSwitch03On", UpdateInterval = 10},
	},
	OnActions	=
	{
	...
	OffConditions =
	{
		IsGlobalFlagFalse{Name = "g_P210Room1aSwitch03On", UpdateInterval = 10},
	},
	OffActions	=
	{
...
-- Source: C:\project\main\mission\dialoge\p210\n9509_Raum1aHebel3.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room1a_switch3_p210_001PC", String = "(Den Hebel umlegen)", AnswerId = 2},
		}}
