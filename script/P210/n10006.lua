...
OnToggleEvent 
{
	...
	OnConditions =
	{
		IsGlobalFlagTrue{Name = "P210Room9Stele06On", UpdateInterval = 15},
	},
	OnActions	=
	{
	...
	OffConditions =
	{
		IsGlobalFlagFalse{Name = "P210Room9Stele06On", UpdateInterval = 15},
	},
	OffActions	=
	{
...
-- Source: C:\project\main\mission\dialoge\p210\n10006_Raum9Stele6.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room9pillar6P210_001PC", String = "(Die Säule berühren)", AnswerId = 2},
		}}
