...
-- Source: C:\project\main\mission\dialoge\p210\n9808_Raum3MenhirF.txt
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room3_menhirF_p210_002PC", String = "(Das Symbol des Hammers berühren)", AnswerId = 3},
			OfferAnswer{Tag = "room3_menhirF_p210_004PC", String = "(Das Symbol der Schaufel berühren)", AnswerId = 7},
		}}
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "room3_menhirF_p210_003", String = "Ein Rumpeln ertönt."},
