...
-- Source: C:\project\main\mission\dialoge\p210\n11202_Binaerstele32.txt
	...
	OnBeginDialog{
		...
		Actions = {
			Say{Tag = "binarpillar32P210_001", String = "(Auf die Vorderseite der Säule ist eine große, schwarze 32 gemalt.)"},
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "binarpillar32P210_002PC", String = "(Die Säule berühren)", AnswerId = 2},
		}}
