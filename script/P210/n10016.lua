...
OnToggleEvent 
{
	...
	OnConditions =
	{
		IsGlobalFlagTrue{Name = "g_P210Room9zSwitch1aOn", UpdateInterval = 10},
	},
	OnActions	=
	{
	...
	OffConditions =
	{
		IsGlobalFlagFalse{Name = "g_P210Room9zSwitch1aOn", UpdateInterval = 10},
	},
	OffActions	=
	{
...
-- Source: C:\project\main\mission\dialoge\p210\n10016_Raum9zHebel1a.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room9zlever1aP210_001PC", String = "(Den Hebel umlegen)", AnswerId = 2},
		}}
	...
	OnAnswer{3;
		...
		Actions = {
			FlipGlobalFlag { Name = "g_P210Room9zSwitch1aOn"},
