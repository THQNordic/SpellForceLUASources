...
-- Source: C:\project\main\mission\dialoge\p210\n10034_Raum9RiddleChest1.txt
	...
	OnBeginDialog{
		...
		Actions = {
			Say{Tag = "room9riddlechest1P210_001", String = "(Die Truhe ist durch sieben Riegel gesichert.)"},
			Answer{Tag = "", String = "", AnswerId = 1},
		}}

	OnAnswer{1;
		Conditions = {
			IsGlobalCounter{Name = "g_P210_Room9StelenRiddle1Lit", Value = 7, Operator = IsEqual},
		},
		Actions = {
			Say{Tag = "room9riddlechest1P210_002", String = "(Alle Riegel sind offen. Die Truhe kann jetzt geöffnet werden.)"},
			Answer{Tag = "", String = "", AnswerId = 2},
		}}

	OnAnswer{1;
		Conditions = {
			Negated(IsGlobalCounter{Name = "g_P210_Room9StelenRiddle1Lit", Value = 7, Operator = IsEqual}),
		},
		Actions = {
			Say{Tag = "", String = ""},
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "room9riddlechest1P210_003", String = "(Sechs Riegel sind offen, einer ist geschlossen.)"},
	...
	OnAnswer{6;
		...
		Actions = {
			Say{Tag = "room9riddlechest1P210_004", String = "(Fünf Riegel sind offen, zwei sind geschlossen.)"},
	...
	OnAnswer{8;
		...
		Actions = {
			Say{Tag = "room9riddlechest1P210_005", String = "(Vier Riegel sind offen, drei sind geschlossen.)"},
	...
	OnAnswer{10;
		...
		Actions = {
			Say{Tag = "room9riddlechest1P210_006", String = "(Drei Riegel sind offen, vier sind geschlossen.)"},
	...
	OnAnswer{12;
		...
		Actions = {
			Say{Tag = "room9riddlechest1P210_007", String = "(Zwei Riegel sind offen, fünf sind geschlossen.)"},
	...
	OnAnswer{14;
		...
		Actions = {
			Say{Tag = "room9riddlechest1P210_008", String = "(Ein Riegel ist offen, sechs sind geschlossen.)"},
	...
	OnAnswer{14;
		...
		Actions = {
			Say{Tag = "room9riddlechest1P210_009", String = "(Alle Riegel sind geschlossen.)"},
