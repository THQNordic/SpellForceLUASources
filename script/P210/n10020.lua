...
OnToggleEvent 
{
	...
	OnConditions =
	{
		IsGlobalFlagTrue{Name = "g_P210Room9zSwitch5aOn", UpdateInterval = 30},
	},
	OnActions	=
	{
	...
	OffConditions =
	{
		IsGlobalFlagFalse{Name = "g_P210Room9zSwitch5aOn", UpdateInterval = 30},
	},
	OffActions	=
	{
...
-- Source: C:\project\main\mission\dialoge\p210\n10020_Raum9zHebel5a.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room9zlever5aP210_001PC", String = "(Den Hebel umlegen)", AnswerId = 2},
		}}
	...
	OnAnswer{3;
		...
		Actions = {
			FlipGlobalFlag { Name = "g_P210Room9zSwitch5aOn"},
