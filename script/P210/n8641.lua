...
-- Source: C:\project\main\mission\dialoge\p210\n8641_Raum2Fackel1.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room2_torch1_p210_001PC", String = "(Die Fackel entzünden)", AnswerId = 2},
		}}
	...
	OnAnswer{4;
		Conditions = {
			Negated(IsGlobalCounter{Name = "P210_Room2RightComboLit", Value = 2, Operator = IsEqual}),
		},
		Actions = {
			Say{Tag = "", String = ""},
	...
	OnAnswer{4;
		Conditions = {
			IsGlobalCounter{Name = "P210_Room2RightComboLit", Value = 2, Operator = IsEqual},
		},
		Actions = {
			Say{Tag = "", String = ""},
