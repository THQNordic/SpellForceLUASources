...
-- Source: C:\project\main\mission\dialoge\p210\n8645_Raum2Fackel5.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room2_torch5_p210_001PC", String = "(Die Fackel entzünden)", AnswerId = 2},
		}}
	...
	OnAnswer{4;
		Conditions = {
			Negated(IsGlobalCounter{Name = "P210_Room2RightComboLit", Value = 4, Operator = IsEqual}),
		},
		Actions = {
			Say{Tag = "", String = ""},
	...
	OnAnswer{4;
		Conditions = {
			IsGlobalCounter{Name = "P210_Room2RightComboLit", Value = 4, Operator = IsEqual},
		},
		Actions = {
			Say{Tag = "", String = ""},
