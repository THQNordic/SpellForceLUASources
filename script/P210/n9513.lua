...
OnToggleEvent 
{
	...
	OnConditions =
	{
		IsGlobalFlagTrue{Name = "g_P210Room1aSwitch07On", UpdateInterval = 10},
	},
	OnActions	=
	{
	...
	OffConditions =
	{
		IsGlobalFlagFalse{Name = "g_P210Room1aSwitch07On", UpdateInterval = 10},
	},
	OffActions	=
	{
...
-- Source: C:\project\main\mission\dialoge\p210\n9513_Raum1aHebel7.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room1a_switch7_p210_001PC", String = "(Den Hebel umlegen)", AnswerId = 2},
		}}
