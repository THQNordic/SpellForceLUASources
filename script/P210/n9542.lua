...
OnToggleEvent 
{
	...
	OnConditions =
	{
		IsGlobalFlagTrue{Name = "g_P210Room1cSwitch09On", UpdateInterval = 30},
	},
	OnActions	=
	{
	...
	OffConditions =
	{
		IsGlobalFlagFalse{Name = "g_P210Room1cSwitch09On", UpdateInterval = 30},
	},
	OffActions	=
	{
...
-- Source: C:\project\main\mission\dialoge\p210\n9542_Raum1cHebel9.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "room1c_switch9_p210_001PC", String = "(Den Hebel umlegen)", AnswerId = 2},
		}}
	...
	OnAnswer{3;
		...
		Actions = {
			FlipGlobalFlag { Name = "g_P210Room1cSwitch09On"},
