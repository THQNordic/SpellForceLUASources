...
-- Source: C:\project\main\mission\dialoge\p210\n9894_KistePhenomena.txt
	...
	OnBeginDialog{
		...
		Actions = {
			Say{Tag = "chest_phenomena_p210_001", String = "(Ein Schlüssel steckt in der Kiste. In ihren Deckel ist ein seltsames Wort eingeritzt.)"},
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "chest_phenomena_p210_003PC", String = "(Den Schlüssel umdrehen)", AnswerId = 3},
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "chest_phenomena_p210_005", String = "(Die Kiste kann jetzt geöffnet werden.)"},
