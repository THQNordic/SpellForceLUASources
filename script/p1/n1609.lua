...
OnIdleGoHome
{
	...
	X = 126, Y = 113, WalkMode = Run, Direction = West
}
...
DefineLocationCircle{X = 87, Y = 136, Range = 2, Name = "Point005"}
DefineLocationCircle{X = 84, Y = 148, Range = 2, Name = "Point006"}
DefineLocationCircle{X = 86, Y = 156, Range = 2, Name = "Point007"}
DefineLocationCircle{X = 84, Y = 162, Range = 2, Name = "Point008"}
DefineLocationCircle{X = 82, Y = 166, Range = 2, Name = "Point009"}
DefineLocationCircle{X = 83, Y = 171, Range = 2, Name = "Point010"}
DefineLocationCircle{X = 81, Y = 178, Range = 2, Name = "Point011"}
DefineLocationCircle{X = 80, Y = 184, Range = 2, Name = "Point012"}
--DefineLocationCircle{X = 80, Y = 191, Range = 2, Name = "Point013"}
--DefineLocationCircle{X = 79, Y = 196, Range = 2, Name = "Point014"}
...
OnIdleGoHome
{
	...
	X = 70, Y = 202, WalkMode = Walk, Direction = SouthEast
}

OnOneTimeEvent
{
	Conditions = {
		FigureInRange{X = 70, Y = 202, Range = 0, UpdateInterval = 5},
