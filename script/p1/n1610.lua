...
OnIdleGoHome
{
	...
	X = 124, Y = 111, WalkMode = Run, Direction = West
}
...
DefineLocationCircle{X = 86, Y = 135, Range = 2, Name = "Point005"}
DefineLocationCircle{X = 83, Y = 147, Range = 2, Name = "Point006"}
DefineLocationCircle{X = 85, Y = 155, Range = 2, Name = "Point007"}
DefineLocationCircle{X = 83, Y = 161, Range = 2, Name = "Point008"}
DefineLocationCircle{X = 82, Y = 166, Range = 2, Name = "Point009"}
DefineLocationCircle{X = 83, Y = 171, Range = 2, Name = "Point010"}
DefineLocationCircle{X = 80, Y = 177, Range = 2, Name = "Point011"}
DefineLocationCircle{X = 79, Y = 183, Range = 2, Name = "Point012"}
--DefineLocationCircle{X = 79, Y = 190, Range = 2, Name = "Point013"}
--DefineLocationCircle{X = 78, Y = 195, Range = 2, Name = "Point014"}
...
OnIdleGoHome
{
	...
	X = 66, Y = 200, WalkMode = Walk, Direction = SouthEast
}

OnOneTimeEvent
{
	Conditions = {
		FigureInRange{X = 66, Y = 200, Range = 0, UpdateInterval = 5},
