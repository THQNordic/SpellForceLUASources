...
OnIdleGoHome
{
	...
	X = 126, Y = 111, WalkMode = Run, Direction = West
}
...
DefineLocationCircle{X = 87, Y = 134, Range = 2, Name = "Point005"}
DefineLocationCircle{X = 84, Y = 146, Range = 2, Name = "Point006"}
DefineLocationCircle{X = 86, Y = 154, Range = 2, Name = "Point007"}
DefineLocationCircle{X = 84, Y = 160, Range = 2, Name = "Point008"}
DefineLocationCircle{X = 82, Y = 166, Range = 2, Name = "Point009"}
DefineLocationCircle{X = 83, Y = 171, Range = 2, Name = "Point010"}
DefineLocationCircle{X = 81, Y = 176, Range = 2, Name = "Point011"}
DefineLocationCircle{X = 80, Y = 182, Range = 2, Name = "Point012"}
--DefineLocationCircle{X = 80, Y = 189, Range = 2, Name = "Point013"}
--DefineLocationCircle{X = 79, Y = 194, Range = 2, Name = "Point014"}
...
OnIdleGoHome
{
	Conditions = {
		...
		--IsGlobalFlagFalse{Name = "Q17TroopsAtPortal"},
	},
	HomeActions = {
	},
	X = 70, Y = 204, WalkMode = Walk, Direction = SouthEast
}

OnOneTimeEvent
{
	Conditions = {
		FigureInRange{X = 70, Y = 204, Range = 0, UpdateInterval = 5},
		IsPlayerFlagFalse{Name = "QuestGetToEloniSolved", UpdateInterval = 5},
		IsGlobalFlagFalse{Name = "EinerGehtZumPortal", UpdateInterval = 5},
	...
	OnAnswer{1;
		...
		Actions = {
			SetNpcFlagTrue{Name = "IchSollDasPortalAufmachen"},
					...
					RemoveDialog{NpcId = 1610}, SetGlobalFlagFalse{Name = "Q17TroopsAtPortal"},
