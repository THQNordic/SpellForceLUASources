...
OnSkeletalAnimation
{
	GotoX = 311, GotoY = 181,			-- despawn destination
	SpawnX = 393, SpawnY = 260,			-- newspawn destination
	RunnerClan = 2,						-- runner unit's clan
	MaxClanSizeRunner = 2,				-- runner clansize
	NewUnits = { 143, 149, 147 },		-- spawn all of these units at destination
	NewUnitsClan = 6,					-- welchen clan die neuen units haben sollen
