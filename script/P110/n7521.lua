...
-- Source: C:\project\main\mission\dialoge\P110\n7521_VendingStone.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "vendingstone110_002", String = "(Eine Inschrift besagt: Opfere drei Münzen deiner Wahl und empfange deine Belohnung.)"},
	...
	OnAnswer{3;
		...
		Actions = {
			Say{Tag = "vendingstone110_009", String = "(Drei Münzen sind in den Menhir gefallen. Ein sonderbares Summen erfüllt die Luft.)"},
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "vendingstone110_003PC", String = "(Sonnenmünze einwerfen)", AnswerId = 5},
			OfferAnswer{Tag = "vendingstone110_005PC", String = "(Mondmünze einwerfen)", AnswerId = 8},
			OfferAnswer{Tag = "vendingstone110_007PC", String = "(Sternmünze einwerfen)", AnswerId = 11},
		}}
	...
	OnAnswer{5;
		...
		Actions = {
			Say{Tag = "vendingstone110_004", String = "(Die Sonnenmünze fällt ins Innere des Menhirs.)"},
	...
	OnAnswer{8;
		...
		Actions = {
			Say{Tag = "vendingstone110_006", String = "(Die Mondmünze fällt ins Innere des Menhirs.)"},
	...
	OnAnswer{11;
		...
		Actions = {
			Say{Tag = "vendingstone110_008", String = "(Die Sternmünze fällt ins Innere des Menhirs)"},
