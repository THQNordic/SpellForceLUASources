...
-- Source: C:\project\main\mission\dialoge\P110\n6227_MenhirSonnenstadt.txt
	...
	OnAnswer{1;
		...
		Actions = {
			Say{Tag = "menhirsonnenstadt110_002", String = "(Darauf eine Inschrift: 'Nur des Meisters Klopfen wird die Pforte öffnen.')"},
	...
	OnAnswer{3;
		...
		Actions = {
			Say{Tag = "menhirsonnenstadt110_005", String = "('Ein bedrohliches Mahlen ist zu hören.')"},
	...
	OnAnswer{5;
		...
		Actions = {
			Say{Tag = "menhirsonnenstadt110_006", String = "(Die Inschrift verändert sich: 'Falsche Hand, falsches Herz.' ... Der Boden erzittert.)"},
	...
	OnAnswer{8;
		...
		Actions = {
			Say{Tag = "menhirsonnenstadt110_008", String = "(Die Faust zerbricht bei der Berührung und zerfällt zu feinem Staub.)"},
	...
	OnAnswer{9;
		...
		Actions = {
			Say{Tag = "menhirsonnenstadt110_009", String = "(Der Durchgang öffnet sich.)"},
