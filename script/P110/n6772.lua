...
-- Source: C:\project\main\mission\dialoge\P110\n6772_Schatzkiste14.txt
	...
	OnBeginDialog{
		...
		Actions = {
			Say{Tag = "schatzkiste14110_001", String = "(Anstelle eines Schlüssellochs ist in diese Kiste ein Schlitz eingelassen. Daneben wurden fünf Totenschädel in das Holz geschnitzt.)"},
	...
	OnAnswer{2;
		...
		Actions = {
			Say{Tag = "", String = ""},
			OfferAnswer{Tag = "schatzkiste14110_002PC", String = "(Schädelmünze in den Schlitz werfen)", AnswerId = 3},
		}}
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "schatzkiste14110_004PC", String = "(Die Münze fällt in den Schlitz. In der Truhe verschiebt sich ein Riegel.)"},
	...
	OnAnswer{4;
		...
		Actions = {
			Say{Tag = "schatzkiste14110_003", String = "(Die Münze fällt in den Schlitz. Der letzte Riegel verschiebt sich. Die Truhe kann jetzt geöffnet werden.)"},
